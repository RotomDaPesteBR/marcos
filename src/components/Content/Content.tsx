    ...
    <Container>
      <Pamonha>
        <PamonhaContainer>
          ...
          <PamonhaImg src="https://marcos-ruddy.vercel.app/panaca.png" alt="" draggable="false" />
        </PamonhaContainer>
        <PamonhaContainer>
          <PamonhaTitle>PANONHA</PamonhaTitle>
          <PamonhaImg src="https://marcos-ruddy.vercel.app/panonha.png" alt="" draggable="false" />
        </PamonhaContainer>
      </Pamonha>
      <LighthouseContainer>
        <Lighthouse src="https://marcos-ruddy.vercel.app/lighthouse.svg" />
      </LighthouseContainer>
      <EuSei>
        <div>
      ...
      <Victor>
        <VictorLeft>
          <VictorContainer>
            <VictorImageContainer>
              <VictorImg src="https://marcos-ruddy.vercel.app/victor.png" alt="" draggable="false" />
              <VictorBackground />
            </VictorImageContainer>
      ...
      <VideoContainer>
        <Video
          ...
          allowFullScreen
        />
        <VideoEffect src="https://marcos-ruddy.vercel.app/video.svg" alt="" draggable="false" />
      </VideoContainer>
      <Vitorioso>
